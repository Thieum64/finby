output "secrets" {
  ...
  value = {
    ...
    shopify_webhook_secret   = google_secret_manager_secret.shopify_webhook_secret.secret_id
...
output "secret_ids" {
  ...
  value = {
    ...
    shopify_webhook_secret   = google_secret_manager_secret.shopify_webhook_secret.id
